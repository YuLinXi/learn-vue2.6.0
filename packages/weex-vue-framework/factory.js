...
function updateVirtualComponent (vnode) {
  ...
  if (vm._isMounted && componentId) {
    // T-O-D-O: data should be filtered and without bindings
...
function resolveVirtualComponent (vnode) {
  ...
  vnode.componentOptions.Ctor = BaseCtor.extend({
    beforeCreate: function beforeCreate () {
      ...
      // T-O-D-O: listen on all events and dispatch them to the
...
var TransitionGroup = {
  ...
  render: function render (h) {
    ...
    if (prevChildren) {
      ...
      prevChildren.forEach(function (c) {
        ...
        // T-O-D-O: record before patch positions
  ...
  updated: function updated () {
    ...
    // T-O-D-O: finish implementing move animations once
